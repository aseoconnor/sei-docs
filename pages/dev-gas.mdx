...
To help end-users and developers better estimate fees, SEI has partnered with Blocknative to develop [SeiGas.com](https://seigas.com) and to build and maintain a third-party fee API powered by custom ML models. Please follow the documentation [here](https://docs.blocknative.com/gas-prediction/gas-platform) to get set up with the API.
